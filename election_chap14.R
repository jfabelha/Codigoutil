...
M2.bugs <- bugs (data, inits, params, "election88.M2.bug", n.chains=3, n.iter=100, bugs.directory="c:/Programas/WinBUGS14/")

# Fit using openbugs

M2.bugs.a <- bugs (data, inits, params, "election88.M2.bug", n.chains=3, n.iter=10, bugs.directory="c:/Programas/WinBUGS14/")
M2.bugs.b <- bugs (data, inits, params, "election88.M2.bug", n.chains=3, n.iter=10, program="OpenBUGS", bugs.directory="c:/Programas/WinBUGS14/")
M2.bugs.c <- openbugs (data, inits, params, "election88.M2.bug", n.chains=3, n.iter=10, bugs.directory="c:/Programas/WinBUGS14/")
